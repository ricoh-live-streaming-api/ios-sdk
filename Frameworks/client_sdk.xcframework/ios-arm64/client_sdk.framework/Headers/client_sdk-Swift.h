...
#ifndef CLIENT_SDK_SWIFT_H
#define CLIENT_SDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="client_sdk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC10client_sdk6Client")
...
@interface Client (SWIFT_EXTENSION(client_sdk)) <RTCPeerConnectionDelegate>
...
SWIFT_CLASS("_TtC10client_sdk22LSClientLogFileManager")
@interface LSClientLogFileManager : DDLogFileManagerDefault
@property (nonatomic, readonly, copy) NSString * _Nonnull newLogFileName;
- (BOOL)isLogFile:(NSString * _Null_unspecified)fileName SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithLogsDirectory:(NSString * _Nullable)logsDirectory OBJC_DESIGNATED_INITIALIZER;
@end
